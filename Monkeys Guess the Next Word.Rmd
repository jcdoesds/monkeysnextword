...
guessed 'not', 'going', and 'a' as likely next words. There is also a graph showing the odds that is the next word, given the user's input based on the data in the model. 
